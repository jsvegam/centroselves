...
async function seed() {
  ...
  try {
    ...
    console.log('Admin user created: admin@centroselves.cl / admin123')
  } catch (e: any) {
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      heroSubtitle: 'Psicoterapia Sistémica Relacional',
  ...
  console.log('Services page saved')
  ...
  console.log('Login: admin@centroselves.cl / admin123')
  process.exit(0)
}
